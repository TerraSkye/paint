...
class Bootstrap extends CApplicationComponent
{
    ...
    public function init()
    {
        ...
        if (Yii::getPathOfAlias('bootstrap') === false)
            Yii::setPathOfAlias('bootstrap', realpath(dirname(__FILE__).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'widgets'.DIRECTORY_SEPARATOR.'bootstrap'));
    ...
    public function registerCoreCss()
    {
        ...
        Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/bootstrap-snet.css');
    }
    ...
    protected function getAssetsUrl()
    {
        ...
        {
            $assetsPath = Yii::getPathOfAlias('application.assets.bootstrap');
