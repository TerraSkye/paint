...
class Question extends ActiveRecord {
	 ...
	 * @return Question the new model class
	 */
	...
	public function rules() {
		...
		return array(
			...
			array('question_id, value, create_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations() {
		...
		return array(
            'options' => array(self::HAS_MANY,'Option','question_id','on' => 'options.source_id = 1' )
		);
	}
