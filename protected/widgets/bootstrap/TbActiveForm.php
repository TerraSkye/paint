...
Yii::import('application.widgets.bootstrap.input.TbInput');
...
class TbActiveForm extends CActiveForm
{
	...
	// Input classes.
	const INPUT_HORIZONTAL = 'application.widgets.bootstrap.input.TbInputHorizontal';
	const INPUT_INLINE = 'application.widgets.bootstrap.input.TbInputInline';
	const INPUT_SEARCH = 'application.widgets.bootstrap.input.TbInputSearch';
	const INPUT_VERTICAL = 'application.widgets.bootstrap.input.TbInputVertical';
