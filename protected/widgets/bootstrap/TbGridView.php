...
Yii::import('application.widgets.bootstrap.TbDataColumn');
...
class TbGridView extends CGridView
{
	 ...
	 * Defaults to <code>array('class'=>'ext.application.widgets.bootstrap.TbPager')</code>.
	 */
	public $pager = array('class'=>'application.widgets.bootstrap.TbPager');
	/**
	...
	protected function initColumns()
	{
		foreach ($this->columns as $i => $column)
		{
			if (is_array($column) && !isset($column['class']))
				$this->columns[$i]['class'] = 'application.widgets.bootstrap.TbDataColumn';
		}
