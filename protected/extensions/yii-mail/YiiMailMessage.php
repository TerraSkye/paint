...
class YiiMailMessage extends CComponent {
	...
	/**
	 * Attach a file in a Yii mail-message
	 * Extended class for attachment
	 * @param CUploadedFile $uploadedFile
	 * @return type 
	 * @author original: diana@kiwity.com [http://code.google.com/p/yii-mail/issues/detail?id=14]
	 */
	public function fileAttach($uploadedFile) {
		$uploadedFileName = $uploadedFile->tempName;
		$swiftAttachment = ExtendedSwiftAttachment::fromPath($uploadedFileName, null, $uploadedFile->name);
